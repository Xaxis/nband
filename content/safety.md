...
This page published the dose figure wrong twice, in opposite directions. Both are corrected here rather than quietly replaced, because both were live long enough to be read.

The figure first published was roughly 40 nanogray per hour at one metre, described as "well under one percent of natural background". A later revision retracted it and claimed about 1,070 nanosieverts per hour, three times background. **The retraction was itself wrong**, by about a factor of a hundred, and it is the number that stood.

The error was a dropped exponent. The tabulated air-kerma rate constant for americium-241 is roughly 3.2 × 10⁻² mGy·m²/(GBq·h). Converting milligray to microgray multiplies by a thousand and converting gigabecquerels to megabecquerels divides by a thousand, so those cancel and the value in the units wanted is still 3.2 × 10⁻², or 0.032 µSv·m²/(MBq·h). It was published as 3.2.

Worked through properly: nine microcuries is 0.33 megabecquerels. The 59.5 keV line alone, at 35.9 percent yield against NIST mass energy-absorption coefficients for air, gives about **1 nSv/h at one metre**. Including the neptunium L X-rays around 14 to 21 keV, which are soft but numerous, raises it to about **9 nSv/h**. The most conservative published constant found in a supplier safety sheet, 85 µSv/h per GBq, gives **28 nSv/h**. Natural background averages around 340 nSv/h.

Across the full spread of defensible values the answer is between a fraction of a percent and about eight percent of background. It is never above background. The figure this page published as three times background was wrong in the alarming direction by roughly two orders of magnitude, and the original 40 nGy/h was about right in magnitude, though its label was not: 40 nGy/h is around twelve percent of background, not "well under one percent".

Shielding was also described wrongly. Two millimetres of aluminium passes about 86 percent of the 59.5 keV line, which is where the claim that it "does not rescue it" came from, but only about 16 percent of the 17 keV L X-rays, and those dominate the bare dose. The housing removes most of it. That was never the reason to shield: alpha and beta are what the aluminium and acrylic stop, and they do that completely.

**The dose was never the problem.** A few percent of background at one metre, falling off as the square of distance, is not what should stop you. The regulatory position is.

The regulatory position was published wrongly too, and it matters more than the dose figure. An earlier revision said the assembly "stays below the United States NRC general-license threshold in 10 CFR 30.15". That is not what 10 CFR 30.15 says. It is an exemption rather than a general license, general licenses live in Part 31, and §30.15(a)(7) exempts "ionization chamber smoke detectors containing not more than 1 microcurie of americium-241 per detector in the form of a foil and designed to protect life and property from fires". The limit is per detector, the exemption attaches to the detector as a fire-protection device, and there is no aggregate activity allowance to sit beneath.
