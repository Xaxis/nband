...
The error was a unit slip in the dose constant. The tabulated air-kerma rate constant for americium-241 is roughly 3.2 × 10⁻² mGy·m²/(GBq·h). The retraction used "3.2 microsieverts per hour per megabecquerel", dropping the 10⁻² and moving from gigabecquerels to megabecquerels — two mistakes in one substitution, compounding to a thousandfold overstatement, partially offset by the value chosen, and nobody caught it because it pointed the alarming way and the surrounding paragraph was busy congratulating itself on rigour.
