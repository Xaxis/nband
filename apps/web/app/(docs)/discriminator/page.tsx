...
export default function DiscriminatorPage() {
  return (
    <>
      <PageHeader
        eyebrow="Analysis"
        title="Deciding what something was, and refusing to when you cannot."
        lede={
          <>
      ...
      >
        ...
        <Note
          kind="warning"
          title="A catalogue that was down is not a catalogue that found nothing"
        >
          <p>
      ...
      >
        ...
        <div className="card mt-4 p-5">
          ...
          <p className="mt-2.5 max-w-[76ch] text-[13.5px] leading-relaxed text-[var(--ink-2)]">
            ...
            engine asks a different and more answerable question: does anything <em>ordinary</em>{' '}
            actually explain this? An event is a candidate for “unresolved” when the best
            conventional hypothesis fails to reach a posterior of 0.40, not when the catch-all wins
            a popularity contest it was designed to lose.
          </p>
        </div>
      </Section>
