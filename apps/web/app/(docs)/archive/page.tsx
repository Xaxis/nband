...
export default function ArchivePage() {
  return (
    <>
      <PageHeader
        eyebrow="Live data"
        title="Everything recorded, and what was concluded from it."
        lede={
          <>
            Every event carries the verdict reached, the reasoning behind it, and the version of the
            discriminator that produced it. Nothing is deleted when the platform changes its mind: a
            re-run adds a verdict beside the old one and demotes it, so the history of how an
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="card p-5">
            ...
            <p className="mt-2.5 text-[13.5px] leading-relaxed text-[var(--ink-2)]">
              ...
              unexplained, and an archive that quietly counted those would manufacture mysteries out
              of its own outages. The filter is there if you want them, and the count of what it
              removed is always shown.
            </p>
          </div>
          <div className="card p-5">
            ...
            <p className="mt-2.5 text-[13.5px] leading-relaxed text-[var(--ink-2)]">
              ...
              manifest carrying the row count and a SHA-256 of the content. An analysis can name the
              exact bytes it was computed from, and a later reader can check they have the same
              ones.
            </p>
